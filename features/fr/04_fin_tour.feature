...
Fonctionnalité: Fin de Tour
  ...
  Règle: A la fin du tour les cartes jouées sont placées sur plateau
    Exemple: Valeurs croissantes
      Etant donné j'ai une carte plus grande que les cartes sur les colonnes du plateau
  ...
  Règle: La plus petite différence
    Exemple: Plus petite différence
      ...
      Lorsque le tour se termine
      Alors ma carte est placée sur la colonne avec la plus petite différence

  Règle: Série terminée
    Exemple: Un joueur pose la 6ème carte
      Etant donné ma carte s'ajoutera en tant que 6ème carte sur une colonne
      Lorsque le tour se termine
      Alors la colonne est ramassée par moi
      Et ma carte devient la nouvelle première carte de la colonne ramassée
  ...
  Il est possible de jouer une carte plus petite si on n'a pas le choix
    ...
    Exemple Jouer une carte plus petite
      Etant donné que je n'ai pas de carte dans ma main qui est plus grande que les 4 colonnes
      Lorsque je joue une carte plus petite
      Alors je ramasse la colonne de mon choix
      Et ma carte devient la nouvelle première carte de la colonne ramassée
